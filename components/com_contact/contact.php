<?php
/**
* @version $Id: contact.php,v 1.1 2005/07/22 01:54:41 eddieajau Exp $
* @package Mambo
* @subpackage Contact
...
function sendmail( $con_id, $option ) {
	...
	mosMail($mosConfig_mailfrom, $name, $contact[0]->email_to, $mosConfig_fromname .': '. $subject, $text, 0, NULL, NULL, NULL, $email, $name );

<?php
/**
* @version $Id: contact.html.php,v 1.1 2005/07/22 01:54:41 eddieajau Exp $
* @package Mambo
* @subpackage Contact
...
class HTML_contact {
	...
	*/
	function showTable( &$params, &$rows, $catid, $tabclass ) {
		...
		$k = 0;
		foreach ($rows as $row) {
			$link = 'index.php?option=com_contact&amp;task=view&amp;catid='. $catid . '&amp;contact_id='. $row->id .'&amp;Itemid='. $Itemid;
			?>
			<tr>

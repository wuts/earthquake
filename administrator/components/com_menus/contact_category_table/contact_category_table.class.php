<?php
/**
* @version $Id: contact_category_table.class.php,v 1.1 2005/07/22 01:52:50 eddieajau Exp $
* @package Mambo
* @subpackage Menus
...
class contact_category_table_menu {
	...
	*/
	function editCategory( $uid, $menutype, $option ) {
		...
		$lists['componentid']	= mosAdminMenus::ComponentCategory( 'componentid', 'com_contact', intval( $menu->componentid ), NULL, 'ordering', 5, 0 ); 
		if ( $uid ) {
			$query = "SELECT name"
			. "\n FROM #__categories"

...
class content_blog_category_html {
	...
	function edit( &$menu, &$lists, &$params, $option ) {
		...
		<tr>
			<th>
			<?php echo $menu->id ? $adminLanguage->A_EDIT : $adminLanguage->A_COMP_ADD;?> <?php echo $adminLanguage->A_COMP_MENUS_MENU_ITEM;?> :: <?php echo $adminLanguage->A_COMP_MENUS_BLOG;?> - <?php echo $adminLanguage->A_COMP_MENUS_CONT_CAT;?>
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					<td valign="top" align="right"><?php echo $adminLanguage->A_COMP_CATEG;?><?php	echo mosToolTip( $adminLanguage->A_COMP_MENUS_CMP_CBC_CATEG );?>:</td>
			 		<td>

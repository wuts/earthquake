...
class content_section_menu_html {
	...
	function editSection( &$menu, &$lists, &$params, $option ) {
		...
		<tr>
			<th>
			<?php echo $menu->id ? $adminLanguage->A_EDIT : $adminLanguage->A_COMP_ADD;?> <?php echo $adminLanguage->A_COMP_MENUS_MENU_ITEM;?> :: <?php echo $adminLanguage->A_COMP_MENUS_TABLE;?>  - <?php echo $adminLanguage->A_COMP_MENUS_CONT_SEC;?>
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					<td width="15%" align="right" valign="top"><?php echo $adminLanguage->A_COMP_NAME; ?>
					<?php
					if ( !$menu->id ) {
						echo mosToolTip( $adminLanguage->A_COMP_MENUS_CMP_CAS_BLANK ); 
					}
					?>:</td>
					<td width="80%">
				...
				<tr>
					<td align="right"><?php echo $adminLanguage->A_COMP_SECTION;?>:</td>
					<td>

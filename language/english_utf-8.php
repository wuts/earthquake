<?php
/**
* @version $Id: english_utf-8.php,v 1.8  2007/12/14 11:27:52 lang3 Exp $
* @package Mambo
...
// Name of CMS
DEFINE('_MAMBORS','Mambors');
DEFINE('_MAMBORS_VERSION', _MAMBORS . $_VERSION->RELEASE . '.' . $_VERSION->DEV_LEVEL );
DEFINE('_D_MAMBORS','<a href="http://www.mambochina.net" target="_blank">' . _MAMBORS . '</a> based on <a href="http://mambo-foundation.org" target="_blank">Mambo</a> is Free Software released under the GNU/GPL License.<br />' . '<a href="http://www.mambochina.net" target="_blank">' . _MAMBORS_VERSION . '</a> is powered by <a href="http://www.mambochina.net" target="_blank">MamboChina.net</a> & <a href="http://www.mambors.org" target="_blank">Mambo Resource</a>.');
...
DEFINE('_SELECT_CAT','Select Category');
DEFINE('_SELECT_SEC','Select Section');
...
DEFINE('_DONT_USE_IMAGE','- Do not use an image -');
DEFINE('_USE_DEFAULT_IMAGE','- Use Default image -');
